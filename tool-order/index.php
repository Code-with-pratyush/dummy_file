    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explore tools</h2>
            ...
            <?php 
                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo SITEURL; ?>category-tools.php?category_id=<?php echo $id; ?>">
    ...
    <section class="tool-menu">
        <div class="container">
            ...
            //Getting tools from Database that are active and featured
            //SQL Query
            $sql2 = "SELECT * FROM tbl_tool WHERE active='Yes' AND featured='Yes' LIMIT 6";
            ...
            //CHeck whether tool available or not
            if($count2>0)
            {
                //tool Available
