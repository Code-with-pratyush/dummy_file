        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>Title: </td>
                    <td>
                        <input type="text" name="title" placeholder="Title of the tool">
                    </td>
                </tr>
                ...
                <tr>
                    <td>Description: </td>
                    <td>
                        <textarea name="description" cols="30" rows="5" placeholder="Description of the tool."></textarea>
                    </td>
                </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name =  "tool-Name-".rand(0000,9999).".".$ext; //New Image Name May Be  tool-Name-657.jpg"
                        ...
                        if($upload==false)
                        {
                            ...
                            header('location:'.SITEURL.'admin/add-tool.php');
                            //STop the process
                            die();
                        }
                ...
                if($res2 == true)
                {
                    ...
                    $_SESSION['add'] = "<div class='success' tool Added Successfully.</div>";
