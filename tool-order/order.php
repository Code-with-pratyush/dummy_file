...
<?php include('partials-front/menu.php'); ?>
    ...
    <?php 
        //CHeck whether tool id is set or not
        if(isset($_GET['tool_id']))
        {
            //Get the tool id and details of the selected tool
            $tool_id = $_GET['tool_id'];

            //Get the DEtails of the SElected tool
            $sql = "SELECT * FROM tbl_tool WHERE id=$tool_id";
            //Execute the Query
            ...
            <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        ...
                        $_SESSION['order'] = "<div class='success text-center'>tool Ordered Successfully.</div>";
                        header('location:'.SITEURL);
                    }
                    else
                    {
                        //Failed to Save Order
                        $_SESSION['order'] = "<div class='error text-center'>Failed to Order tool.</div>";
                        header('location:'.SITEURL);
                    }
