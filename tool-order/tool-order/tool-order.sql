...
(4, 'Pizza', 'tool_Category_790.jpg', 'Yes', 'Yes'),
(5, 'Burger', 'tool_Category_344.jpg', 'Yes', 'Yes'),
(6, 'MoMo', 'tool_Category_77.jpg', 'Yes', 'Yes'),
(8, 'Quia est ipsum id id', 'tool_Category_929.jpg', 'No', 'Yes');
...
INSERT INTO `tbl_tool` (`id`, `title`, `description`, `price`, `image_name`, `category_id`, `featured`, `active`) VALUES
(3, 'Dumplings Specials', 'Chicken Dumpling with herbs from Mountains', '5.00', 'tool-Name-3649.jpg', 6, 'Yes', 'Yes'),
(4, 'Best Burger', 'Burger with Ham, Pineapple and lots of Cheese.', '4.00', 'tool-Name-6340.jpg', 5, 'Yes', 'Yes'),
(5, 'Smoky BBQ Pizza', 'Best Firewood Pizza in Town.', '6.00', 'tool-Name-8298.jpg', 4, 'No', 'Yes'),
(6, 'Sadeko Momo', 'Best Spicy Momo for Winter', '6.00', 'tool-Name-7387.jpg', 6, 'Yes', 'Yes'),
(7, 'Mixed Pizza', 'Pizza with chicken, Ham, Buff, Mushroom and Vegetables', '10.00', 'tool-Name-7833.jpg', 4, 'Yes', 'Yes'),
...
INSERT INTO `tbl_order` (`id`, `tool`, `price`, `qty`, `total`, `order_date`, `status`, `customer_name`, `customer_contact`, `customer_email`, `customer_address`) VALUES
